...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/maps-cli-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12116&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/maps-cli-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `maps-cli` can be installed with:

```
conda install maps-cli
```

It is possible to list all of the versions of `maps-cli` available on your platform with:
